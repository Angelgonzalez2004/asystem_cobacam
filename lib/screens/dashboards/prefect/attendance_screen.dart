...
class _AttendanceScreenState extends State<AttendanceScreen> {
    ...
    if (!online) {
      ...
      if (groupSchedulesBox.isNotEmpty) {
        ...
        for (var entry in groupSchedulesBox.toMap().entries) {
          newGroupSchedulesMap[entry.key as String] =
  ...
  Future<void> _registerAttendance(Student student, String scanType,
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildMedicalInfoBox('ESTADO GENERAL',
                cleanStatus.isNotEmpty ? cleanStatus : 'No especificado'),
            if (cleanConditions.isNotEmpty &&
                cleanConditions.toLowerCase() != 'ninguna')
              _buildMedicalInfoBox('CONDICIONES', cleanConditions),
            if (cleanAllergies.isNotEmpty &&
                cleanAllergies.toLowerCase() != 'ninguna')
  ...
  Future<void> _saveQuickIncidence(
    ...
    try {
      final newRef =
          FirebaseDatabase.instance.ref('planteles/$_campus/incidents').push();
  ...
  Widget _buildStatsDashboard(ThemeData theme) {
    ...
    int entradas =
        _todayAttendance.where((r) => r.containsKey('entryTime')).length;
    int salidas =
        _todayAttendance.where((r) => r.containsKey('exitTime')).length;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _statItem(tardes.toString(), 'Tardes', Colors.orange,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          ...
                          width: _scannerBorderColor == Colors.transparent
                              ? 0
                              : 6),
                      boxShadow: const [
  ...
  void _showMassAttendanceDialog() {
    ...
    if (!_isDayValidForAttendance(
        (msg) => UiHelpers.showSnackBar(context, msg, isError: true))) {
      return;
    }
            ...
            actions: [
              ...
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: Colors.white),
                onPressed:
                    (scope == null || (scope == 'group' && groupId == null))
                        ? null
                        : () {
