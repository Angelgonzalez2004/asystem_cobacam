  ...
  Future<void> _editGroupSchedule(
    ...
    if (_isReadOnly) {
      UiHelpers.showSnackBar(
          context, 'Ciclo cerrado. No se pueden modificar horarios.',
          isError: true);
      return;
    }
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    items: _weekdays
                        ...
                        .toList(),
                    onChanged: existingSchedule != null
                        ? null
                        : (value) {
                            // Disable day change if editing existing
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final double startDouble =
                        entryTime!.hour + entryTime!.minute / 60.0;
                    final double endDouble =
                        exitTime!.hour + exitTime!.minute / 60.0;

                    if (startDouble >= endDouble) {
                      UiHelpers.showSnackBar(
                          context, 'La salida debe ser después de la entrada.',
                          isError: true);
                      return;
                    }
                    ...
                    try {
                      final scheduleData = GroupSchedule(
                        ...
                        entryTime: entryTime!.format(
                            context), // Use context for formatting consistency
                          ...
                          ? const Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 16),
                                  Text("No hay grupos en este ciclo.",
                                  ...
                                  child: Card(
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        subtitle: Text(
                                          hasSchedules
                                              ? '${schedulesForGroup.length} días asignados'
